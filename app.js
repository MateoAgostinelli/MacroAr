...
const SERIES = [
  ...
  },
  {
    id:        'pbi',
    slug:      'pbi-trimestral',
    descripcion: 'Producto Interno Bruto (PBI) de Argentina: serie trimestral a precios corrientes publicada por INDEC.',
    titulo:    'Producto Interno Bruto (PBI)',
    categoria: 'Actividad Económica',
    fuente:    'indec',
    ...
    options: {
      ...
      scales: {
        ...
        y: {
          ticks: {
            font: { size: 10 },
            callback: (v, i, ticks) => formatTickEje(v, ticks),
          },
          grid:   { color: '#f1f5f9' },
          border: { display: false },
        },
